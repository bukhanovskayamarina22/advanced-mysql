...
-- For example, if Lucky Shrub enters a product id P3 and the year 2021



CREATE FUNCTION FindSoldQuantity(id VARCHAR(10), year VARCHAR(4))
RETURNS INT DETERMINISTIC
RETURN (SELECT SUM(Quantity) FROM Orders WHERE YEAR(Date) = year AND ProductID = id);



SELECT FindSoldQuantity('P3', '2021') as 'Sold P3 in 2021';
